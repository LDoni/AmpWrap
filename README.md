...
## Nanopore Workflow
1. Initial quality control with [FastQC](https://github.com/s-andrews/FastQC) and QC report generation with [MultiQC](https://github.com/MultiQC/MultiQC)
2. Primer removal with [Porechop](https://github.com/rrwick/Porechop). The use of **Porechop** for trimming is optional and depends on the `trimming_method` parameter in the config file.
